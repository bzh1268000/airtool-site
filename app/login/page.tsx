...
function LoginContent() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center px-4 py-12 overflow-hidden">
      {/* Background — mirrors homepage hero */}
      ...
      <div className="relative z-20 w-full max-w-md rounded-3xl border border-white/60 bg-white/75 p-8 shadow-xl backdrop-blur-md">
